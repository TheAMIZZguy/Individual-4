...
```{r horse_pops, fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972", echo = FALSE}
...
```{r horse_pop_sd, fig.cap = "Horse populations for the province with the largest standard deviation"}
knitr::include_graphics("../../results/horse_pop_plot_largest_sd.png")
```

In Figure \@ref(fig:horse_pop_sd) we zoom in and look at the province of `r `, which had the largest spread of values in terms of standard deviation.
