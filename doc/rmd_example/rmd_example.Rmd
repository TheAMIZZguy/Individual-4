...
```{r horse_pops, fig.cap = "Horse populations for all provinces in Canada from 1906 - 1972", echo = FALSE, out.width = 150%}
...
```{r horses_table, echo = FALSE, show_col_types = FALSE}
...
```{r horse_pop_sd, fig.cap = "Horse populations for the province with the largest standard deviation", echo = FALSE, out.width = "50%"}
